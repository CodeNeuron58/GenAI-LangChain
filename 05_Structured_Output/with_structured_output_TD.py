...
from typing import TypedDict, Annotated, Optional, Literal  # Importing type hinting utilities for structured output
...
# Define the schema for the structured output using TypedDict
...
print(result["name"]) # pyright: ignore[reportIndexIssue]
